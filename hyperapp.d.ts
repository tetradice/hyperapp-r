 ...
 * @memberOf [App]
 */
export interface EffectRunner<State = unknown, NextPayload = void, Props = void> {
 ...
 * @memberOf [App]
 */
export interface SubscriptionRunner<State = unknown, NextPayload = void, Props = void> {
    (dispatch: Dispatch<State, NextPayload>, props: Props): (() => void);
}
 ...
 * @memberOf [App]
 */
export type SubscriptionsResult<State> = (Subscription<State> | Falsy)[] | Subscription<State> | Falsy;
...
export interface JSXAttribute extends EventAttributes {
    ...
    created?: JSXAttribute['oncreate'];

    onupdate?: (elem: HTMLElement, oldAttributes: object) => void;
    updated?: JSXAttribute['onupdate'];

    onremove?: (elem: HTMLElement, done: () => void) => void;
    removing?: JSXAttribute['onremove'];

    ondestroy?: (elem: HTMLElement) => void;
    destroyed?: JSXAttribute['ondestroy'];
